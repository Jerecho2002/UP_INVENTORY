...
<template>
    <div>
        <div class="flex flex-col sm:flex-row flex-wrap w-full gap-3 justify-end mt-3">
            <!-- PRINT -->
            <button
        ...
        <div class="flex flex-col sm:flex-row justify-between items-end gap-4 mb-4 mt-[1rem]">
                                            ...
                                            <div v-for="sdf in secondDropdown" :key="sdf.label" class="flex gap-3">
                                                <div>
                                                    ...
                                                    <select v-model="form[sdf.model]"
                                                        ...
                                                        <option value="">Select</option>
                                                        <option v-for="op in sdf.options" :key="op.value"
                                                            :value="op.value">
                                                            {{
                                                                op.label }}</option>
                                                    </select>
                    ...
                    <tbody class="text-gray-700">
                        <tr v-for="item in rows.data" :key="item.id" class="even:bg-gray-200">
                                        ...
                                        <ViewModal>
                                            ...
                                            <template #ViewBodyContent>
                                                <div v-if="selectedViewItem"
                                                    class="font-bold text-2xl mb-4 text-[#850038]">
                                                    <h2>Item Details</h2>
                                                </div>

                                                <!-- DETAILS GRID -->
                                                <div v-if="selectedViewItem"
                                                    class="grid grid-cols-1 md:grid-cols-1 gap-2">
                                        ...
                                        <EditModal ref="editModalRef">
                                            ...
                                            <template #EditInventory="{ closeModal }">
                                                <form @submit.prevent="handleUpdateItem(form.id, closeModal)"
                                                    class="flex flex-col  sm:overflow-y-auto">
                                                    ...
                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                        ...
                                                        <div class="space-y-6 col-span-1 md:col-span-1">
                                                            <div
                                                                class="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-6">
                                                                <div class="space-y-5">
                                                                    <!-- firstDropdown -->
                                                                    <div class="flex flex-col md:flex-row gap-3 mb-8">
                                                                        <div v-for="fdp in firstDropdown"
                                                                            :key="fdp.name" class="flex flex-col">
                                                                            <label
                         ...
                         focus:outline-none focus:border-[#850038]">
                                                                    ...
                                                                    <!-- secondDropdown -->
                                                                    <div class="flex md:flex-row gap-3 mb-3">
                                                                        <div v-for="sdf in secondDropdown"
                                                                            :key="sdf.label" class="flex gap-3">
                                                                            <div>
                                                                                <label
                                                                                    class="block text-sm font-bold mb-1">{{
                                                                                        sdf.label }}</label>
                                                                        ...
                                                                        <div>
                                                                            <label
                                                                                class="block text-sm font-bold mb-1">Date
                                                                                Acquired</label>
                                                                            <input v-model="form.date_acquired"
                                                                                type="date"
                                                                                class="rounded-md w-full sm:w-[10rem] border border-gray-300 px-3 py-3 bg-[#F8F8F8] text-sm focus:ring-1 focus:ring-[#850038] focus:outline-none focus:border-[#850038]" />
                                                        ...
                                                        <div class="space-y-4">
                                                            <div class="flex flex-col">
                                                                <!-- Invoices + Fund Sources -->
                                                                <div class="flex flex-col md:flex-row gap-4 mb-4">
                                                                    <div v-for="inv in invoicesFundFields"
                                                                        :key="inv.model">
                                                                        <label class="block text-sm font-bold mb-1">{{
                                                                            inv.label
                                                                        }}</label>
